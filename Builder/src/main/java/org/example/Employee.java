...
public class Employee {
    ...
    private Employee(int age, String name, String gender, Address address, List<Phone> phones, List<Contact> contacts) {
        this.age = age;
        this.name = name;
        this.gender = gender;
    ...
    public static class EmployeeBuilder implements IBuilder { // static to be able to call the internal class
        ...
        public EmployeeBuilder setAPhone(Phone phone){
            this.phones.add(phone);
            return this;
        }

        public EmployeeBuilder setAPhone(String phoneNumber, String ext, String phoneType){
        ...
        public EmployeeBuilder setAPhone(String name, Phone phone, Address address){
